...
export default class Bracket extends React.Component<BracketProps, BracketState>{
    ...
    render() {
        ...
        let saveButton = <Button text='Save' clickHandler={this.postBracketToServer} disabled={isBracketComplete(this.props) && !this.props.bracketID || new Date() > new Date(Date.UTC(2017, 10, 16, 22, 0, 0, 0)) ? false : true} />
